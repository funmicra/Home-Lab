...
- **Ansible:**
  ...
  - [Playbooks](https://github.com/funmicra/Home-Lab/tree/master/Fundamentals/Andible) for updating, upgrading, provisioning, user creation, and system configuration
